...
## Admin clean pending v6.6

This version removes the need for a `Change Summary` Airtable field.

The human-readable proposed change summary is now appended into the existing:
...
Required Pending Changes fields remain:
