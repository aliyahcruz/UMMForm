...
const ROUTE_FIELDS = ["Medication", "Medication ID", "Generic Name", "Route", "Location", "UMMS Formulary Status", "Notes", "Therapeutic Interchanges"];
...
export default function AdminPage() {
  ...
  const routeFuse = useMemo(() => new Fuse(routes, {
    keys: ["Medication ID", "Generic Name", "Route", "Location", "UMMS Formulary Status", "Notes", "Therapeutic Interchanges"],
    threshold: 0.35,
    ignoreLocation: true,
    minMatchCharLength: 2
  }), [routes]);
