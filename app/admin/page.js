...
function RecordEditor({ title, endpointBase, tableName, record, editKey, adminName, preferredFields = [], onSaved, versionHistory = [] }) {
...
export default function AdminPage() {
  ...
  return (
    <main>
      ...
      <p className="versionMarker">Admin submitted-by v6.4</p>
    </main>
  );
}
