...
function getVisibleRouteRows(record, selectedLocation) {
  ...
  // UMM Formulary rows are detail-only rows.
  // They should never appear in the top Location/Route/Status or Route/Status table.
  // Their fields are displayed only in the Home Infusion Details box when Home Infusion is selected.
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <p className="versionMarker">Home Infusion update v4.1 · HI details below table v4.9 · Removed HI status row v5.0 · Detail-only HI rows v5.1</p>
    </main>
  );
}
