...
export default function Home() {
  ...
  return (
    <main>
                    ...
                    <div className={selectedLocation ? "routeTable noLocationColumn" : "routeTable"}>
                      ...
                      {record.routes.map(route => (
                        <div className={selectedLocation ? "routeTableRow noLocationColumn" : "routeTableRow"} key={route.id}>
                          ...
                          {selectedLocation === "Home Infusion" && route.source === "UMM Formulary" && getHomeInfusionDetails(route).length > 0 && (
      ...
      <p className="versionMarker">Home Infusion update v4.1 · Faster load v4.2 · Refined search v4.3 · Brand-aware routes v4.4 · Home Infusion details v4.5 · Specific fields v4.6</p>
    </main>
  );
}
