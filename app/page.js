...
const HOME_INFUSION_DETAIL_FIELDS = [
  ...
  { label: "Peds, Renal, Liver, etc Considerations", aliases: ["Peds, Renal, Liver, etc Considerations", "Peds Renal Liver Considerations", "Peds/Renal/Liver Considerations", "Pediatric Renal Liver Considerations"] },
  { label: "Pretreatment Screening Requirements", aliases: ["Pretreatment Screening Requirements", "Pretreatment", "Pre-treatment", "Pre Treatment"] },
  { label: "Ongoing Treatment Parameters", aliases: ["Ongoing Treatment Parameters", "Ongoing Treatment"] },
  { label: "1st Lifetime Dose in HOPD", aliases: ["1st Lifetime Dose in HOPD", "1st Lifetime Dose", "First Lifetime Dose", "First Dose"] },
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <p className="versionMarker">Home Infusion update v4.1 · HI details below table v4.9 · Removed HI status row v5.0 · Detail-only HI rows v5.1 · Strict HI details v5.2 · Selected HI columns v5.5 · Scroll fix v5.3 · Selected HI columns v5.5 · Selected HI columns v5.5</p>
    </main>
  );
}
