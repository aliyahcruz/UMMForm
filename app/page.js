...
export default function Home() {
  ...
  return (
    <main>
                    ...
                    <div className={selectedLocation ? "routeTable noLocationColumn" : "routeTable"}>
                      ...
                      {record.routes.map(route => (
                        <div className={selectedLocation ? "routeTableRow noLocationColumn" : "routeTableRow"} key={route.id}>
                          ...
                          {route.source === "UMM Formulary" && <small className="routeNotes sourceNote">Source: UMM Formulary</small>}
                        </div>
                      ))}
                    </div>
                  </div>
      ...
      <p className="versionMarker">Home Infusion update v4.1 · Faster load v4.2 · Refined search v4.3 · Brand-aware routes v4.4</p>
    </main>
  );
}
