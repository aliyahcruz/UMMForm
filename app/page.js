...
export default function Home() {
  ...
  return (
    <main>
      ...
      <p className="versionMarker">Home Infusion update v4.1 · HI details below table v4.9 · Removed HI status row v5.0 · Detail-only HI rows v5.1 · Strict HI details v5.2 · Scroll fix v5.3</p>
    </main>
  );
}
